...
CREATE TABLE fabric_patterns (
    ...
    CONSTRAINT fk_fp_fabric FOREIGN KEY (fabric_id) REFERENCES fabrics(id),
    CONSTRAINT fk_fp_pattern FOREIGN KEY (pattern_id) REFERENCES patterns(id),
...
CREATE TABLE orders (
    ...
    determined_size ENUM('XS', 'S', 'M', 'L', 'XL', 'XXL') NOT NULL,
    ...
    CONSTRAINT fk_orders_worker FOREIGN KEY (assigned_worker_id) REFERENCES workers(user_id) ON DELETE SET NULL,
    CONSTRAINT fk_orders_measurement FOREIGN KEY (user_measurement_id) REFERENCES user_measurements(id),
    CONSTRAINT fk_orders_fabric_pattern FOREIGN KEY (fabric_pattern_id) REFERENCES fabric_patterns(id)
);
